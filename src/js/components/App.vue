<template>
  <div class="flex items-center justify-center w-full h-full">
    ...
    <div
      class="absolute inset-0 top-auto p-4 text-indigo-500 dark:text-indigo-200"
    >
      <div class="flex flex-row items-center justify-start -mx-1">
        ...
        >
          ...
          >
            ...
            ></path>
            <path
              d="M5.637 19.778l-1.414-1.414l2.121-2.121l1.414 1.414z"
              fill="currentColor"
            ></path>
            <path
              d="M16.242 6.344l2.122-2.122l1.414 1.414l-2.122 2.122z"
              fill="currentColor"
            ></path>
            <path
              d="M6.344 7.759L4.223 5.637l1.415-1.414l2.12 2.122z"
              fill="currentColor"
            ></path>
            <path
              d="M19.778 18.364l-1.414 1.414l-2.122-2.122l1.414-1.414z"
              fill="currentColor"
            ></path>
          </svg>
          <svg
