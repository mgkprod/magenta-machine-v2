    ...
    <div class="absolute inset-0 top-auto p-4 text-indigo-500 dark:text-indigo-200">
      <div class="flex flex-row items-center justify-start -mx-1">
        ...
        >
          ...
          >
            <path
              d="M6.995 12c0 2.761 2.246 5.007 5.007 5.007s5.007-2.246 5.007-5.007s-2.246-5.007-5.007-5.007S6.995 9.239 6.995 12zM11 19h2v3h-2zm0-17h2v3h-2zm-9 9h3v2H2zm17 0h3v2h-3z"
              fill="currentColor"
            ></path>
            <path d="M5.637 19.778l-1.414-1.414l2.121-2.121l1.414 1.414z" fill="currentColor"></path>
            <path d="M16.242 6.344l2.122-2.122l1.414 1.414l-2.122 2.122z" fill="currentColor"></path>
            <path d="M6.344 7.759L4.223 5.637l1.415-1.414l2.12 2.122z" fill="currentColor"></path>
            <path d="M19.778 18.364l-1.414 1.414l-2.122-2.122l1.414-1.414z" fill="currentColor"></path>
          </svg>
          <svg
            v-if="theme == 'dark'"
            xmlns="http://www.w3.org/2000/svg"
          ...
          >
            <path
              ...
              fill="currentColor"
            ></path>
            <path d="M4.219 18.363l2.12-2.122l1.415 1.414l-2.12 2.122z" fill="currentColor"></path>
            <path d="M16.24 6.344l2.122-2.122l1.414 1.414l-2.122 2.122z" fill="currentColor"></path>
            <path d="M6.342 7.759L4.22 5.637l1.415-1.414l2.12 2.122z" fill="currentColor"></path>
            <path d="M19.776 18.364l-1.414 1.414l-2.122-2.122l1.414-1.414z" fill="currentColor"></path>
          </svg>
        </button>
      </div>
    </div>
